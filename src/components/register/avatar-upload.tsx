...
export function Avatar() {
    ...
    return (
        <div className=" px-6">
            <div className="relative flex size-20 border-[var(--detailMinimal)] border-4 items-center justify-center cursor-pointer overflow-hidden rounded-full bg-muted shadow-sm shadow-black/10" onClick={() => handleThumbnailClick("avatar")}>
                {currentImage ? (
