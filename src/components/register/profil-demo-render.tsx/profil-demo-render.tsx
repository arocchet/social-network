...
const ProfilDemoRender = () => {
    const { imageData, username, biography, dateOfBirth, firstname, lasttname } = useUserForm()
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row">
                        ...
                        <div className="flex-1 space-y-2">
                            <Label>Prénom</Label>
                            <Input placeholder="Matt" defaultValue="Margaret" type="text" required value={firstname} />
                        </div>
                        <div className="flex-1 space-y-2">
                            <Label>Nom</Label>
                            <Input placeholder="Welsh" defaultValue="Villard" type="text" required value={lasttname} />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea placeholder="Write a few sentences about yourself" value={biography} />
                    </div>
                </form>
            </div>
